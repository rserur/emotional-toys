...
class TutorialScreen:
	...
	def __init__(self, screen):
		...
		self._InstructionRect = pygame.Rect(100,100,700,200)
	...
	def draw(self):
		...
		if (self.step < self.numSteps):
			self._InstructionText = render_textrect(self._Instructions[self.step],self._InstructionFont,self._InstructionRect,self._UnselectedColor,purple,1)
